      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown active">
          ...
          <ul class="dropdown-menu">
            <li><a href="Georgian.php">Georgian College</a></li>
            <li><a href="Loyalist.php">Loyalist College</a></li>
            <li><a href="Fleming.php">Fleming College</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="StLawrence.php">St. Lawrence College</a></li>
            <li><a href="Algonquin.php">Algonquin College</a></li>
            <li><a href="LaCite.php">La Cité Collégiale</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="Mohawk.php">Mohawk College</a></li>
            <li><a href="Sheridan.php">Sheridan College</a></li>
            <li><a href="Durham.php">Durham College</a></li>
            <li><a href="Centennial.php">Centennial College</a></li>
            <li><a href="GeorgeBrown.php">George Brown College</a></li>
            <li><a href="Humber.php">Humber College</a></li>
            <li><a href="Seneca.php">Seneca College</a></li>
            <li><a href="Niagara.php">Niagara College</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="Conestoga.php">Conestoga College</a></li>
            <li><a href="Fanshawe.php">Fanshawe College</a></li>
            <li><a href="Lambton.php">Lambton College</a></li>
            <li><a href="StClair.php">St. Clair College</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="Candore.php">Candore College</a></li>
            <li><a href="Sault.php">Sault College</a></li>
            <li><a href="Cambrian.php">Cambrian College</a></li>
            <li><a href="Confederation.php">Confederation College</a></li>
            <li><a href="Boreal.php">Collège Boréal</a></li>
            <li><a href="Northern.php">Northern College</a></li>
          </ul>
        </li>
        <li class="dropdown">
        ...
        <div class="row">
            <div class="col-lg-12">
              <div class="well well-lg" style="box-shadow: 5px 5px 5px #888;height:300px;">
                <img class="img-responsive img-rounded" src="../resources/images/Algonquin.jpg" style="height:100%;width:100%">
              </div>
            </div>
        </div>
    </div>
    <div class="col-lg-5">
        <div class="well well-lg" style="box-shadow: 5px 5px 5px #888;height:300px;">
          <div>
            ...
            $query = "SELECT * FROM College_Info WHERE CollegeID = 6";
            ...
            echo "<h3>College Name: " . $row["CollegeName"]. "</h3>";
            echo "<h3>College Location: " . $row["Province"]. "</h3><br>";
            echo "<h4>Avg. Course Content Score: " . $row["ScoreOne"]. "</h4>";
            echo "<h4>Avg. Instructor Score: " . $row["ScoreTwo"]. "</h4>";
            echo "<h4>Avg. Campus Score: " . $row["ScoreThree"]. "</h4>";
  ...
  <div class="col-lg-10">
    <div class="well well-lg" style="box-shadow: 5px 5px 5px #888;">
      <form action="../resources/php/AddReview.php" method="post">
        <input type="hidden" value=6 name="CollegeID">
        ...
        <div class="g-recaptcha" data-sitekey="6Ldk6hsUAAAAABff-vE3nIooHPTlGiLtWw_iGh_s"></div><br>
...
<div class="row spaced">
  ...
  <div class="col-lg-10">
      ...
      $query = "SELECT * FROM Reviews WHERE CollegeID = 6";
