        ...
        <div class="row">
            <div class="col-lg-12">
              <div class="well well-lg" style="box-shadow: 5px 5px 5px #888;height:300px;">
                <img class="img-responsive img-rounded" src="../resources/images/Candore.jpg" style="height:100%;width:100%">
              </div>
            </div>
        </div>
    </div>
    <div class="col-lg-5">
        <div class="well well-lg" style="box-shadow: 5px 5px 5px #888;height:300px;">
          <div>
            ...
            $query = "SELECT * FROM College_Info WHERE CollegeID = 19";
  ...
  <div class="col-lg-10">
    <div class="well well-lg" style="box-shadow: 5px 5px 5px #888;">
      <form action="../resources/php/AddReview.php" method="post">
        <input type="hidden" value=19 name="CollegeID">
...
<div class="row spaced">
  ...
  <div class="col-lg-10">
      ...
      $query = "SELECT * FROM Reviews WHERE CollegeID = 19";
